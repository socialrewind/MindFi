    ...
    public class DBLayer
    {
        ...
        public static bool CreateDB(string file, string user, string password = null)
        {
            lock (obj)
            {
                ...
                string origin = System.Windows.Forms.Application.StartupPath + "\\Template.db";
        ...
        public static bool RespQueueSave(long? ID, string response, int State = AsyncReqQueue.RECEIVED)
        {
            string SQL = "";
