...
namespace MyBackup
{
	...
	/// </summary>
		...
		+ "\\MyBackupTests\\";
            ...
            this.folderDialog1.RootFolder = Environment.SpecialFolder.Personal;
            this.folderDialog1.SelectedPath = MyDocBase + "\\" + tempD;
            this.folderDialog1.Description = "Select the backup folder";
            DialogResult res = this.folderDialog1.ShowDialog();
	    if ( res == DialogResult.Cancel )
	    {
		return;
	    }
	    if (!System.IO.Directory.Exists(folderDialog1.SelectedPath))
            {
                System.IO.Directory.CreateDirectory(folderDialog1.SelectedPath);
            }
	    saveFileDialog1.InitialDirectory = folderDialog1.SelectedPath;
            saveFileDialog1.FileName = folderDialog1.SelectedPath + "\\" + tempD + ".db";
